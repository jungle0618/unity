...
public class GameManager : MonoBehaviour
{
    ...
    public SpawnPointManager SpawnPointManager => spawnPointManager;
    ...
    private void RefreshSystemReferences()
    {
        ...
        if (spawnPointManager == null)
            Debug.LogWarning("[GameManager] SpawnPointManager not found in scene!");
        else
            Debug.Log("[GameManager] SpawnPointManager found and registered");
    }
    ...
    private void ClearGameplayReferences()
    {
        ...
        if (spawnPointManager != null)
        {
            // SpawnPointManager already has singleton pattern, so keep it
            Debug.Log("[GameManager] Keeping SpawnPointManager (it persists across scenes)");
        }
    }
