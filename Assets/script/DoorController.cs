...
public class DoorManager : MonoBehaviour
{
    ...
    public TileBase doorClosedCollider; // 這是有 collider 的 Tile（放在 collisionTilemap）
    // 若開門時要移除 collider，直接把 collisionTilemap 的該格設為 null
    ...
    void Start()
    {
        // 掃描 visualTilemap 範圍，找出一開始是 doorClosedVisual 的格子
